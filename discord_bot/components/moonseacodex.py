...
class MSCTradeSearchResultsEmbed(Embed):
    ...
    rarity_colours = {'uncommon': Colour.dark_green(), 'rare': Colour.dark_blue(), 'veryrare': Colour.dark_purple(), 'legendary': Colour.dark_orange()}
    ...
    def __init__(self, advert):
        ...
        self.add_field(name='Moonsea Codex', value=f"[Link to item on Moonsea Codex](https://digitaldemiplane.com/moonseacodex/magicitem/{item_uuid}/)", inline=False)
