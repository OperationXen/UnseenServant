...
from api.views.dm_banlist import DMBanListViewset
...
view_actions_CLD = {"get": "list", "post": "create", "delete": "delete"}
...
urlpatterns = [
    ...
    re_path(
        "dungeonmasters/banlist/(?P<discord_name>\w+)?/?$",
        DMBanListViewset.as_view(view_actions_CLD),
        name="dms-banlist",
    ),
